...
public class Map {
	...
	/**
	 * 現在のマップを返します．なおマップからゲームに関する情報をすべて取得できます．
	 * 既にマップのインスタンスが存在する場合は createOrUpdateMap の方が効率が良いです．
	 * 
	 * @param sc
	 *            マップデータを受け取るためのScanner
	 * @return マップ
	 */
	public static Map createMap(Scanner sc) {
		return createOrUpdateMap(null, sc);
	}
